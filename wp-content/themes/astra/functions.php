...
function redirect_logged_in_user() {
    // Define the URL to which logged-in users should be redirected
    $redirect_url = home_url('/messages/'); // Change '/your-custom-page/' to your desired URL
    ...
    // Redirect logged-in users trying to access the register page
    if ( is_user_logged_in() && is_page('register') ) {  // Assuming 'register' is the slug of your register page
        wp_redirect($redirect_url);
        exit;
    }

    // Redirect logged-in users trying to access the home page (main index)
...
function get_current_user_display_name() {
    if (is_user_logged_in()) {
        ...
        return ucwords($current_user->display_name);
    }
    return '';
}
